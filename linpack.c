...
static void daxpy_r  (int n,REAL da,REAL * restrict dx,int incx,REAL * restrict dy,int incy);
static REAL ddot_r   (int n,REAL * restrict dx,int incx,REAL * restrict dy,int incy);
static void dscal_r  (int n,REAL da,REAL * restrict dx,int incx);
static void daxpy_ur (int n,REAL da,REAL * restrict dx,int incx,REAL * restrict dy,int incy);
static REAL ddot_ur  (int n,REAL * restrict dx,int incx,REAL * restrict dy,int incy);
static void dscal_ur (int n,REAL da,REAL * restrict dx,int incx);
static int  idamax   (int n,REAL * restrict dx,int incx);
...
static REAL second(void)
    ...
    {
    return ((REAL)((REAL)__TSC/(REAL)1000000000));
    }
